...
module.exports = function stylelintWarningToVscodeDiagnostic(
	...
	return Diagnostic.create(
		//TODO: this is the root cause for only a single character being the root for the fix.
		//TODO: try creating a range which includes the text length (warning.text) to make the range include the entire text
